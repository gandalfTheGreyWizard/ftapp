...
<script type="text/javascript">
  ...
  if (screen.width <= 800) {
    window.location = "./browsermob.php";
  }
...
<body style="background-color:rgb(69,130,61);"><h2 align = "center">BROWSER</h2>';
...
<button type="submit"> <img src = "./ico1/reset.png"> </button>
</form>
<td>
<form method = "post" action = "browser.php">
<input type = "hidden" name = "back">
<button type="submit"><img src = "./ico1/prev.png"></button>
</form>
</table>
...
$ab = scandir($dir);
echo '<tr><td style="border:6px solid black;background:rgb(34,143,20);"><h3> BROWSER WINDOW </h3>';
...
echo'<td valign="top" style="border:6px solid black;background:rgb(34,143,20);">';
for ($i=2;$i < count($ab);$i++)
{	$ext = strrpos($ab[$i], '.')==""?"":substr($ab[$i], strrpos($ab[$i], '.') + 1);
